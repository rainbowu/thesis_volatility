...
class NoneObject(object):
    ...
    def __str__(self):
        ...
        if self.strict:
            ...
            sys.exit(0)
	#20.02.2013 / Android-Plugins: android plugins generate alot of these warnings but remain functional, reason for this has to be investigated. excluded these lines to improve readability of plugin output
        #else:
